...
alter table public.projects
  drop column if exists external_video_urls;
...
insert into public.projects (slug, title, excerpt, image_url, image_urls, tags, tech_stack, project_tools, client, category, timeline, role, published_at, sort_order)
values
  ('my-porto-web', 'My Porto Web', 'Personal portfolio website for Elthon Jhon Kevin, built with Next.js and Supabase integration.', '/images/profile-photo.png', array['/images/profile-photo.png'], array['portfolio', 'full-stack'], array['Next.js', 'Supabase', 'TypeScript'], array['Git', 'Docker', 'Figma'], 'Personal', 'Portfolio Website', 'Ongoing', 'Full-stack Developer', current_date, 1)
...
insert into public.posts (slug, category, published_at, title, excerpt, read_time, image_url, image_urls, author_name, author_initials, content, tags)
values
